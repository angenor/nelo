...
class AppColors {
  ...
  // Primary colors - Orange/Coral (vibrant African-inspired)
  ...
  static const Color secondaryLight = Color(0xFF8B73F0);
  static const Color secondaryDark = Color(0xFF5338C7);
